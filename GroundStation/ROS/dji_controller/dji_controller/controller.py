...
class DjiNode(Node):
    def __init__(self):
        ...
        self.create_subscription(
            Float64MultiArray,
            "command/goto_waypoint_pid_tuning",
            self.goto_waypoint_pid_tuning_callback,
            10,
        )
    ...
    def goto_waypoint_callback(self, msg: Float64MultiArray):
        ...
        self.dji_interface.requestSendGoToWPwithPID(latitude, longitude, altitude, yaw, speed)
    ...
    def goto_waypoint_pid_tuning_callback(self, msg: Float64MultiArray):
        ...
        if len(data) >= 10:
            ...
            self.get_logger().warning(
                "Received an array with fewer than 10 elements for PID tuning."
            )
